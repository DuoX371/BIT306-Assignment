...
export class RequestService {
  private requests = [
    ...
    {id: 4, description: 'Help in Hot', date: '2022-12-03', time: '13:50', studentLevel: 'Diploma', expectedStudents: 50, status: 'NEW', sadminId: 2, requestDate: new Date().toISOString().split('T')[0]},
